...
public class View_created_postTest extends AbstractPageTest {
	  ...
	  void View_created_post() {
			...
			WebElement click_on_btn_SeeMyPosts = getWebDriver().findElement(By.xpath("//div[@id=\"app\"]/main/div/div/div[1]/div/div[1]/div/div/div/div[3]/div[1]/button[1]/span"));
			click_on_btn_SeeMyPosts.click();

			WebElement click_on_creating_post = getWebDriver().findElement(By.xpath("//div[@id=\"app\"]/main/div/div[3]/div[1]/a[1]/img"));
